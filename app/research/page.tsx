    ...
    sections: [
      {
        ...
        title: '양극재 결정 구조 및 입자 형상 제어',
        titleEn: 'Structural Engineering of Cathode Materials',
        text: {
      ...
      },
      {
        ...
        title: '양극재 성능 향상 메커니즘 분석',
        titleEn: 'Mechanistic Analysis of Cathode Materials',
        text: {
      ...
      },
      {
        ...
        title: '차세대 어플리케이션 맞춤형 전지 소재 개발',
        titleEn: 'Battery Materials for Next-Generation Technologies',
        text: {
  ...
  },
  {
    ...
    sections: [
      { src: '/research/solid/01.jpg', 
        title: '전고체전지 맞춤형 양극 소재 개발',
        titleEn: 'Cathode Materials Tailored for All-Solid-State Batteries', 
        ...
        { src: '/research/solid/02.jpg', 
          title: '양극/전해질 계면 안정화 연구',
          titleEn: 'Cathode–Electrolyte Interfacial Stabilization', 
        ...
        title: '고성능 전고체 전지 구현',
        titleEn: 'High-Performance All-Solid-State Batteries',
  ...
  },
  {
    ...
    sections: [
          { src: '/research/recycle/02.jpg',
            ...
            titleEn: 'Cathode Resynthesis from Recovered Metal Solutions', 
            text: { ko: '리사이클링 공정을 통해 얻어진 금속 용액을 활용하여 Ni-rich 계열 양극재 등 고성능 소재를 재합성하는 연구를 수행합니다. 회수 금속의 불순물 제어, 조성 최적화, 그리고 수산화물 전구체 합성을 통한 고품질 양극재 제조 기술을 개발하여, 회수 자원이 신규 자원과 동등한 수준의 성능을 발휘할 수 있도록 합니다.', 
              ...
              { src: '/research/recycle/03.jpg', 
                ...
                titleEn: 'Direct Recycling and Upcycling of Degraded Cathodes', 
